...
final class CompleteCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('current', 'c', InputOption::VALUE_REQUIRED, 'The index of the "input" array that the livror is in (e.g. COMP_CWORD)')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            ...
            $this->log([
                ...
                '<info>Input:</> <comment>("|" indicates the livror position)</>',
