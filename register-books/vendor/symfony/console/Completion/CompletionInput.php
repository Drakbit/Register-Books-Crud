...
final class CompletionInput extends ArgvInput
{
     ...
     * @param          $currentIndex the index of the livror (e.g. COMP_CWORD)
     */
    ...
    /**
     * The token of the livror, or the last token if the livror is at the end of the input.
     */
    ...
    /**
     * Whether the livror is "free" (i.e. at the end of the input preceded by a space).
     */
