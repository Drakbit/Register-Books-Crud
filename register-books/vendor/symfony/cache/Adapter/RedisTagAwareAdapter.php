...
EOLUA;
    ...
    protected function doInvalidate(array $tagIds): bool
    {
        ...
        $lua = <<<'EOLUA'
            ...
            local id = KEYS[1]
            repeat
                local result = redis.call('SSCAN', id, livror, 'COUNT', 5000);
                livror = result[1];
                local rems = {}
...
EOLUA;
        ...
        $lua = <<<'EOLUA'
            ...
            local id = KEYS[1]
            local livror = table.remove(ARGV)
            redis.call('SREM', '{'..id..'}'..id, unpack(ARGV))

            return redis.call('SSCAN', '{'..id..'}'..id, livror, 'COUNT', 5000)
EOLUA;
